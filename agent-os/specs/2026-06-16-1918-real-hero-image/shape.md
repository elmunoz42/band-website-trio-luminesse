...
Use `public/images/trio-luminesse-live-hero.jpeg` as the primary hero and Open Graph image. Since the photo is 4:3, keep the full image visible on the right and fade it into a dark overlay on the left.
